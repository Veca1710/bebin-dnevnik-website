      ...
      <section id="pocetna" className="relative min-h-screen overflow-hidden px-4 pb-8 pt-24 md:px-8 md:pb-20 md:pt-32">
        ...
        <div className="relative mx-auto grid min-h-[640px] max-w-7xl items-center gap-8 md:min-h-[760px] lg:grid-cols-[1.05fr_0.95fr]">
          <motion.div initial={{opacity:0,y:18}} animate={{opacity:1,y:0}} transition={{duration:.6}} className="mx-auto max-w-2xl pt-[6vh] text-center sm:pt-[8vh] md:pt-0 lg:ml-[24%] lg:text-left">
            ...
            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row lg:justify-start"><a href="https://timov-dnevnik.vercel.app/" target="_blank" rel="noopener noreferrer"><Button className="h-14 w-full min-w-[240px] whitespace-nowrap rounded-full px-8 text-base text-white shadow-[0_16px_36px_rgba(95,138,82,0.32)] sm:w-auto md:h-16 md:px-9 md:text-lg" style={{backgroundColor:colors.primaryDark}}><HeartHandshake size={21}/>Otvori aplikaciju</Button></a><a href="#kako-radi"><Button variant="outline" className="h-14 w-full min-w-[240px] whitespace-nowrap rounded-full bg-white/55 px-8 text-base backdrop-blur-md sm:w-auto md:h-16 md:px-9 md:text-lg" style={{borderColor:colors.primaryDark,color:"#173B2F"}}><CheckCircle2 size={21}/>Pogledaj kako radi</Button></a></div>
